...
#%% using pickle to save list
with open("all_body_tags_list.txt","wb") as file:
  pickle.dump(all_bodies , file)


  # # code for reading list again
  # with open("all_body_tags_list.txt", "rb") as file:
  #   all_tags = pickle.load(file)
