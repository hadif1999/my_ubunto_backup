...
plugins=(git zsh-syntax-highlighting poetry docker docker-compose celery python tmux)
...
__conda_setup="$('/home/hadi/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/hadi/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/hadi/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/hadi/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
